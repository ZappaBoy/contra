    ...
    <div class="flex flex-col items-center">
      ...
      <div class="space-y-6 w-full">
        <div class="flex flex-wrap justify-center gap-4">
          <a
            v-for="username in githubUsername.split(',')" :key="username"
          ...
          >
            ...
            <span class="ml-2 text-white font-medium">{{ username }}</span>
          </a>

          <a
            v-for="username in gitlabUsername.split(',')" :key="username"
...
export default {
  ...
  methods: {
    async getGithubProfilePicture() {
      const res = await this.$axios.get(`https://api.github.com/users/${this.githubUsername.split(',')[0]}`, {})
